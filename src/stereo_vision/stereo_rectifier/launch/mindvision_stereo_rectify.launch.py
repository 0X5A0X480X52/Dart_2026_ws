...
def generate_launch_description():
    """
    Complete stereo camera pipeline with MindVision cameras and image rectification.
    
    This launch file includes:
    - Left and right MindVision camera drivers
    ...
    stereo_container = ComposableNodeContainer(
        name='stereo_mindvision_container',
        namespace='',
        package='rclcpp_components',
        executable='component_container',
        composable_node_descriptions=[
            # Left MindVision camera
            ComposableNode(
                package='ros2_mindvision_camera',
                plugin='mindvision_camera::MindVisionCameraNode',
